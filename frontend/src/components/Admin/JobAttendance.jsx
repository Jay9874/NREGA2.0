        ...
        <li key={workIdx} className='rounded-2xl bg-white shadow relative'>
          <div className='flex w-full items-center gap-2 flex-wrap justify-between p-6'>
            <div className='flex-1'>
              ...
              <p className='mt-1 truncate text-sm text-gray-500'>{work.date}</p>
            </div>
                ...
                {selectedFile && (
                  <div className='preview-cont relative h-[150px] w-[150px]'>
                    ...
                    <div className='absolute flex flex-col items-center gap-2 top-0 right-0 z-10 p-1'>
                      <label title='Change Image' className='edit-btn cursor-pointer flex items-center justify-center rounded-full h-[24px] w-[24px] bg-gray-200 '>
                      ...
                      <button onClick={()=>setSelectedFile(null)} title='Cancel' className='close-btn flex items-center justify-center rounded-full h-[24px] w-[24px] bg-gray-200 '>
