          ...
          <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56  overflow-auto'>
            ...
            <div className='text-center'>
              ...
              <div className='mt-10 flex-wrap flex items-center justify-center gap-x-6'>
                <Link
                  to='/auth'
                  className='rounded-md bg-green-500 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-green-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400'
                >
                  Get started
                </Link>
                <Link
